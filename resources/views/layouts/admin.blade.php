                ...
                <div class="container">
                    <div class="d-flex">
                        <a class="header-brand" href="./index.html">
                            <img src="{{ asset('admin/demo/brand/tabler.svg') }}" class="header-brand-img"
                                alt="tabler logo">
                        </a>
                  ...
                  <a href="https://github.com/tabler/tabler" class="btn btn-sm btn-outline-primary" target="_blank">Source code</a>
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a href="#" class="dropdown-item d-flex">
                                        <span class="avatar mr-3 align-self-center"
                                            style="background-image: url({{ asset('admin/demo/faces/male/41.jpg') }})"></span>
                                        <div>
                                    ...
                                    <a href="#" class="dropdown-item d-flex">
                                        <span class="avatar mr-3 align-self-center"
                                            style="background-image: url({{ asset('admin/demo/faces/female/1.jpg') }})"></span>
                                        <div>
                                    ...
                                    <a href="#" class="dropdown-item d-flex">
                                        <span class="avatar mr-3 align-self-center"
                                            style="background-image: url({{ asset('admin/demo/faces/female/18.jpg') }})"></span>
                                        <div>
                            ...
                            <div class="dropdown">
                                <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                                    <span class="avatar"
                                        style="background-image: url({{ asset('admin/demo/faces/female/25.jpg') }})"></span>
                                    <span class="ml-2 d-none d-lg-block">
                                        <span class="text-default">{{ Auth::user()->firstname }}
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg order-lg-first">
                            <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                                <li class="nav-item">
                                    <a href="{{ route('admin') }}" class="nav-link active"><i class="fe fe-home"></i>
                                        Home</a>
                                </li>
                                <li class="nav-item">
                                    <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i
                                            class="fe fe-box"></i> Properties</a>
                                    <div class="dropdown-menu dropdown-menu-arrow">
                                        <a href="{{ route('add-property') }}" class="dropdown-item ">New Property</a>
                                        <a href="{{ route('admin-properties-table') }}"
                                            class="dropdown-item ">Property Table</a>
                                        <a href="{{ route('admin-properties') }}" class="dropdown-item ">Property
                                            Gallery</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i
                                            class="fe fe-calendar"></i> Users</a>
                                    <div class="dropdown-menu dropdown-menu-arrow">
                                        <a href="{{ route('users') }}" class="dropdown-item ">All users</a>
                ...
                <div class="container">
                  ...
                  <a href="https://github.com/tabler/tabler" class="btn btn-outline-primary btn-sm">Source code</a>
                        ...
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0 text-center">
                            ...
                            </script> <a href=".">Real Estate</a>. Powered By by <a href="stormcell.com"
                                target="_blank">Stormcell</a> All rights reserved.
                        </div>
                    </div>
                </div>
            </footer>
