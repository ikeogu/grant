        ...
        <div class=" py-5 ">
            <div class="container ">
                <div class="row justify-content-center mb-4">
                    <h4><strong class="">Purchased Properties</strong></h4>
                </div>

                @if (count(Auth::user()->purchased) > 0)
                    @foreach (Auth::user()->purchased as $item)
                            ...
                            <div class="row p-2 justify-content-center ">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-7 bg-so p-0 shadow">
                                    <div class=" px-2 mx-5 mt-3 justify-content-center ">
                                        ...
                                        <div class="badge badge-danger ml-5 p-2">Sold</div>
                                    </div>
