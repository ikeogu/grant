			          ...
			          <div class="row">
			            ...
			            <div class="col-md-6">
			              <div class="form-group">
			                ...
			                <input type="number" name="area" class="form-control" placeholder="e.g 3" value="{{ $property->area }}" required>
			              </div>
			              @error('area')
			              	<li class="text-danger">{{ $message }}</li>
			              @enderror
			            ...
			            <div class="col-md-6">
			              <div class="form-group">
			                ...
			                <input type="number" name="length" class="form-control" placeholder="e.g 100" value="{{$property->length}}" required>
			              </div>
			              @error('length')
			              	<li class="text-danger">{{ $message }}</li>
			              @enderror
			            ...
			            <div class="col-md-6">
			              <div class="form-group">
			                ...
			                <input type="number" name="width" class="form-control" placeholder="e.g 3" value="{{ $property->width }}" required>
			              </div>
			              @error('width')
			              	<li class="text-danger">{{ $message }}</li>
			              @enderror
